                ...
                <div class="col-lg-6 animated slideInRight">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center justify-content-lg-end mb-0">
                            ...
                            <li class="breadcrumb-item"><a class="text-primary" href="<?= Url::to(['site/service']) ?>">Pages</a></li>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="row g-0">
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay=" <?=$s ?>s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center <?php echo $s==0.2?'bg-primary':'bg-light'; ?>">
                            ...
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="<?= Yii::getAlias('@web/img/testimonial-'.$n.'.jpg') ?>" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
